...
def generate_all_years_deceased_heatmap(excel_path, logo_path, shp_path):
    ...
    <div class="titr-box" style="position: fixed; bottom: 20px; left: 20px; z-index:9999;
        ...
        مجموع کل فوتی از سال 1393 تا 1403: {total_deceased}
    </div>
    """
    ...
    map_zanjan.save("atlas_zanjan_Deceased_HeatMap_AllYears.html")