...
def generate_all_years_mountain_circle_map(excel_path, logo_path, shp_path):
    ...
    for _, row in df_mountain.iterrows():
    ...
    <div class="titr-box" style="position: fixed; bottom: 20px; left: 20px; z-index:9999;
        ...
        تعداد کل حوادث کوهستان از سال 1393 تا 1403: {len(df_mountain)}
    </div>
    """
    ...
    map_zanjan.save("atlas_zanjan_Mountain_Circle_AllYears.html")