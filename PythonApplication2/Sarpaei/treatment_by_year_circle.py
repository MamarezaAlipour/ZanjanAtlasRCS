...
def generate_yearly_treatment_circle_maps(excel_path, logo_path, shp_path):
    ...
    for year in range(1393, 1404):
        ...
        add_value_circles(
            map_zanjan,
            df_year,
            "درمان سرپايي توسط جمعیت/نفر",
            value_label="درمان سرپایی",
        ...
        total_treatment_year = int(df_year["درمان سرپايي توسط جمعیت/نفر"].sum())
        count_html = f"""
        <style>
        @font-face {{
