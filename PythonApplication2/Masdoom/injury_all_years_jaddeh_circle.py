...
def generate_all_years_injury_jaddeh_circle_map(excel_path, logo_path, shp_path):
    ...
    total_injuries = int(df_jaddeh['تعداد کل مصدومین در حادثه /نفر'].sum())
    count_html = f"""
    <style>
    @font-face {{ 
        font-family: 'BTitr';
    ...
    <div class="titr-box" style="position: fixed; bottom: 20px; left: 20px; z-index:9999;
        ...
        مجموع کل مصدومین جاده ای از سال 1393 تا 1403: {total_injuries}
    </div>
    """
    ...
    map_zanjan.save("atlas_zanjan_Jaddeh_Injury_Circle_AllYears.html")